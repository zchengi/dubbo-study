...
//        main.test_trade_precreate();
    ...
    public void test_monitor_sys() {
        ...
        AlipayHeartbeatSynRequestBuilder builder = new AlipayHeartbeatSynRequestBuilder()
                .setAppAuthToken(appAuthToken).setProduct(Product.FP).setType(com.alipay.demo.trade.model.hb.Type.CR)
                .setEquipmentId("cr1000001").setEquipmentStatus(com.alipay.demo.trade.model.hb.EquipStatus.NORMAL)
    ...
    public void test_trade_query() {
        ...
        String outTradeNo = "chengtest11111111";
...
//                + (long) (Math.random() * 10000000L);
        ...
        com.alipay.demo.trade.model.builder.AlipayTradePrecreateRequestBuilder builder = new com.alipay.demo.trade.model.builder.AlipayTradePrecreateRequestBuilder()
        ...
        switch (result.getTradeStatus()) {
            case SUCCESS:
                ...
                // 需要修改为运行机器上的路径
                String filePath = String.format("D:/Appserv/ftp/qrcode/qr-%s.png",
